...
// ---------------------------------------------------------------------------
// i18n: the port has no translation catalog, so every string is its own
// translation. i18n_get returns the source string; i18n_free_all is a no-op
// because nothing was allocated.
// ponytail: add a real catalog (pbl/services/i18n) for localized strings.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// system_theme: content-size theming is absent, so every text style maps to the
// single loaded system font (fonts_get_system_font ignores the key).
// ponytail: port shell/system_theme + a real font table for per-style faces.
// ---------------------------------------------------------------------------
